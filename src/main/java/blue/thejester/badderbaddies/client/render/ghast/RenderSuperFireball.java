...
import blue.thejester.badderbaddies.item.ItemSuperFireball;
...
public class RenderSuperFireball extends RenderFireball {
    private final float scale;

    public RenderSuperFireball(RenderManager renderManagerIn, float scaleIn) {
    ...
    public void doRender(EntityFireball entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        TextureAtlasSprite textureatlassprite = Minecraft.getMinecraft().getRenderItem().getItemModelMesher().getParticleIcon(ItemSuperFireball.item);
